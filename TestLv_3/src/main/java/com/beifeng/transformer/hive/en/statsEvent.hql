...
-- 5. 创建hive的function
create function event_convert as 'com.beifeng.transformer.hive.EventDimensionUDF' using jar 'hdfs://mini1:8020/beifeng/transformer/transformer-0.0.1.jar';
...
-- 7. sqoop脚步编写
sqoop export --connect jdbc:mysql://192.168.4.1:3306/report --username root --password ls515011 --table stats_event --export-dir /hive/bigdater.db/stats_event/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key platform_dimension_id,date_dimension_id,event_dimension_id
