...
sqoop export --connect jdbc:mysql://192.168.4.1:3306/report --username root --password ls515011 --table stats_event --export-dir /hive/bigdater.db/stats_event/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key platform_dimension_id,data_dimension_id,event_dimension_id
